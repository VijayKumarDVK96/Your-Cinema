...
export class TmdbService {
  ...
  static async getWatchProviders(_tmdbId: number, _title?: string, _originalTitle?: string): Promise<any[]> {
    // Globally disabled: auto OTT provider import and TMDB watch providers import are turned off.
    // Users explicitly manage and link their own playback/OTT sources.
    return [];
  }
